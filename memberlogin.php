...
<head>
    ...
    <link href="log/vendot/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet" media="all">
...
<body>
 ...
 <div id="js-preloader" class="js-preloader">
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <li><a href="register.php" class="active">Register <img src="assets/images/profile-header.jpg" alt=""></a></li>
                        </ul>
			...
			<div class="wrap-login100">
				...
				<?php
							if(isset($_POST['Submit'])){
								...
								$sql="select * from customer where cus_user='{$_POST['user']}' and cus_pwd='".md5($_POST['pwd']). "' LIMIT 1";
    ...
    <script src="logvendors/jquery/jquery.min.js"></script>
    <script src="logvendors/bootstrap/js/bootstrap.min.js"></script>
