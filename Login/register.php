...
<body>
                ...
                <div class="card-body">
                    ...
                    <fieldset>
                       <!-- <div class="input-group">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="name" id="cus_name" name="cus_name" required="">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="password" placeholder="password" id="cus_pwd" name="cus_pwd" required="">
                        </div>
                        <div class="p-t-10">
                            <button  id="Submit" name="Submit" class="btn btn--pill btn--green" type="Submit">Submit</button>
                        </div>
                        <div class="form-group">
                           <br><p class="text-center"><a href="memberlogin.php"  id="signup" class="success"><h5>go to sign in</h5></a></p></br>
                           </div>
                        </fieldset>
                    </form>
                    <?php
    ...
    mysqli_query($conn,"SET NAMES utf8"); //ทำให้อ่านข้อมูลที่เป็นภาษาไทยได้
        ...
        echo "window.location='../cd-shop/index.php';";
		echo "</script>";
