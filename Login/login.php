				...
				<div class="login100-pic js-tilt" data-tilt>
                    ...
                    <span class="login100-form-title">
                        ...
                        <br></center>
                           ...
                           <div class="form-group">
						   <p class="text-center"><h6>Go to your Homepage </h6><a href="index.php"  id="signup" class="success"><h6>Click Here</h6></a></p>
                           </div>
                        </form>
				<?php
							if(isset($_POST['Submit'])){
								...
								$sql="select * from admin where ad_usr='{$_POST['usr']}' and ad_pwd='".md5($_POST['pwd'])."' LIMIT 1";
								$rs = mysqli_query($conn, $sql);
							    $num = mysqli_num_rows($rs);
	
							if ($num > 0){
								$data = mysqli_fetch_array($rs);
								$_SESSION['ses_id']= $data['ad_id'];
								$_SESSION['ses_name']= $data['ad_name'];
								echo "<script>";
