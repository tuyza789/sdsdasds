            ...
            <div class="col-lg-12">
              ...
              <ul>
               ...
               include("connectdb.php");
                $sql = "SELECT  *  FROM  `order`  where order.o_member = '".$_GET['m']."'";
              ...
              ?>
                ...
                <ul>
                  ...
                  <li><div class="main-button"><a href="detail.php?a=<?=$data['o_id'];?>">ดูรายละเอียด</a></div></li>
                  <li><div class="main-button"><a href="cle3.php?a=<?=$data['o_id'];?>">ลบ</a></div></li>
                </ul>
                <?php } // end foreach ?>
