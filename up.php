...
<div class="form-group" align="center">
  <label class="col-md-14 control-label" for="id_a">รหัสสินค้า</label>  
  <div class="col-md-14">
  <input id="id_a" name="id_a" type="text" class="form-control input-md" required
  autofocus value="<?=$data['id_a'];?>" readonly>
...
<div class="form-group">
  <label class="col-md-14 control-label" for="name_a">ชื่อสินค้า</label>  
  <div class="col-md-14">
  <input id="name_a" name="name_a" type="text" class="form-control input-md" required value="<?=$data['album_a'];?>">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-14 control-label" for="art_a">ชื่อเพลงตัวอย่าง</label>  
  <div class="col-md-14">
  <input id="art_a" name="art_a" type="text" class="form-control input-md" required value="<?=$data['art_a'];?>">
...
<!-- Textarea -->
<div class="form-group">
  <label class="col-md-14 control-label" for="price_a">ราคาสินค้า</label>
  <div class="col-md-14">                     
    <input id="price_a" name="price_a" type="text" class="form-control input-md" required value="<?=$data['price_a'];?>">
  </div>
</div>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-14 control-label" for="album_a">ชื่ออัลบัม</label>  
  <div class="col-md-14">
  <input id="album_a" name="album_a" type="text" class="form-control input-md" required value="<?=$data['album_a'];?>">
...
<!-- Textarea -->
<div class="form-group">
  <label class="col-md-14 control-label" for="detail_a">รายละเอียดสินค้า</label>
  <div class="col-md-14">                     
  <textarea class="form-control" id="detail_a" name="detail_a"><?=$data['detail_a'];?></textarea>
  </div>
</div>

<!-- Textarea -->
<div class="form-group">
  <label class="col-md-14 control-label" for="type_a">ประเภท</label>
  <div class="col-md-14">                     
    <input id="type_a" name="type_a" type="text" class="form-control input-md" required value="<?=$data['type_a'];?>">
  </div>
</div>
...
<!-- File Button --> 
<div class="form-group">
  <label class="col-md-14 control-label" for="img">รูปสินค้า</label>
  <div class="col-md-14">
...
<!-- File Button --> 
<div class="form-group">
  <label class="col-md-14 control-label" for="audio">ไฟล์เพลงสินค้า</label>
  <div class="col-md-14">
...
<?php
    ...
    include("connectdb.php");
		...
		$sql = " UPDATE `album` SET  name_a='{$_POST['name_a']}',art_a= '{$_POST['art_a']}', price_a='{$_POST['price_a']}',album_a= '{$_POST['album_a']}',detail_a= '{$_POST['detail_a']}',type_a= '{$_POST['type_a']}' where `album`.`id_a` = {$_GET['id']};";
...
?>
    ...
    <script src="log/vendot/jquery/jquery.min.js"></script>
    <!-- Vendor JS-->
    <script src="log/vendot/select2/select2.min.js"></script>
    <script src="log/vendot/datepicker/moment.min.js"></script>
    <script src="log/vendot/datepicker/daterangepicker.js"></script>

    <!-- Main JS-->
    <script src="log/jt/global.js"></script>
...
<!--===============================================================================================-->	
	<script src="log/vendors/jquery/jquery-3.2.1.min.js"></script>
<!--===============================================================================================-->
	<script src="log/vendors/bootstrap/js/popper.js"></script>
	<script src="log/vendors/bootstrap/js/bootstrap.min.js"></script>
<!--===============================================================================================-->
	<script src="log/vendors/select2/select2.min.js"></script>
<!--===============================================================================================-->
	<script src="log/vendors/tilt/tilt.jquery.min.js"></script>
	<script >
		$('.js-tilt').tilt({
			scale: 1.1
		})
