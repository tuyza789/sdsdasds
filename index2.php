                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="header-text">
                                    ...
                                    <h4><em>Hello  </em><?=$_SESSION['ses_name'];?></h4>
...
<a href="index2.php?pt=<?=$data2['pt_id'];?>" ><?=$data2['pt_name'];?></a> &nbsp;
        ...
        <?php
						...
						<div class="col-lg-3 col-sm-8">	
								<div class="item">
                                         ...
                                         <a href="pro.php?a=<?=$data['id_a'];?>"><img src='image/<?=$data['id_a']?>.jpg' ></a>     
                                         ...
                                         <h4><?=$data['album_a'];?><br>
											...
											<div class="main-button"style="font-size:10%" >
												<a href="pro.php?a=<?=$data['id_a'];?>" style="font-size:12px">รายละเอียด</a>
                                                <a href="bas.php?id=<?=$data['id_a'];?>" class="bi bi-cart-plus-fill" role="button"></a>
