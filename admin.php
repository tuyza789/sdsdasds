                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <li><a href="view_member.php">สมาชิก</a></li>
                            ...
                            <li><a href="view_order.php">ดูออเดอร์ <img src="assets/images/profile-header.jpg" alt=""></a></li>
                        </ul>
                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="header-text">
                                    ...
                                    <h4><em></em>For  Admin  Playpleng</h4>
                                    <div class="main-button">
                                    
                                        <a href="insertpage.php">เพิ่มสินค้า</a>
                                        <a href="view_order.php">ดูออเดอร์</a>
                                        <a href="view_member.php">สมาชิก</a>
                                    </div>
                                </div>
                            </div>
                        </div>
								...
								<div class="item">
                                         ...
                                         <h4><?=$data['album_a'];?><br>
											...
											<div class="main-button"style="font-size:10%" >
												<a href="up.php?id=<?=$data['id_a'];?>" style="font-size:10px">แก้ไข</a>
                                            
                                                <a href="de.php?id=<?=$data['id_a'];?>"onClick="return confirm('ยืนยันการลบ?');" style="font-size:10px">ลบ</a>
