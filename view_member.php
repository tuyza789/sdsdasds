        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
              ...
              <ul>
                  ...
                  <li><h4>ชื่อลูกค้า</h4></li>
                  
                  <li><h4>เบอร์โทร</h4></li>
                  <li><h4>ที่อยู่</h4></li>
              ...
              ?>
                ...
                <ul>
                  ...
                  <li><h4><?=$data['cus_id'];?></h4></li>
                  <li><h4><?=$data['cus_name'];?></h4></li>
                  <!--<li><h4><?=$_SESSION['itema'][$pid];?></h4></li>-->
                  <li><h4><?=$data['cus_phone'];?></h4></li>
                  <li><h4><?=$data['cus_adress'];?></h4></li>
                  <li><h4><?=$data['cus_user'];?></h4></li>
                  <li><div class="main-button"><a href="cle4.php?e=<?=$data['cus_id'];?>">ลบ</a></div></li>
                </ul>
                <?php } // end foreach ?>
